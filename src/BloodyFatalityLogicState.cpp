...
BloodyFatalityLogicState::BloodyFatalityLogicState(StateStack &stack, State::Context context, GameState &game_state)
    ...
    auto bloody_fatality_candidates = m_game_state->get_world()->get_bloody_fatality_candidates();
